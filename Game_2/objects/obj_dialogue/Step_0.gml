...
/*
if (stage == 0){
	draw_text(150, 30, ("It is the year 2050, the world is facing the threat" 
	+ " of an alien invasion from neighboring galaxy andromeda"))
	space = true
}

if (stage == 1){
	draw_text(150, 30, ("Project I.R.E.L.I.A, the international defense agency created by "
	+"the United Nations Security Council, has decided to deploy four " 
	+"special troops to combat the threat head-on."))
}

if (stage == 2){
	draw_text(150, 30, ("The team has faced countless threats before, and dealt with them according"
	+" to the knowledge and skill they have gainied over their years of combat"))
}

if (stage == 3){
	draw_text(150, 30, ("But this time was different. The threat was greater"))
}
	
if (stage == 4){
	draw_text(150, 30, ("These are their stories, Welcome to Irelia"))
}
...
/*
if (stage == 5){
	draw_text(150, 30, ("Ransacked City: 2050"))
}


if (stage == 6){
	draw_text(150, 30, ("IRELIA has just received an urgent call "
	+"regarding a direct alien attack on a city"))
}

if (stage == 7){
	draw_text(150, 30, ("Team Alpha is now being deployed in the ruined city"))
}

if (stage == 8){
	draw_text(150, 30, ("Get ready..."))
}
...
/*
if (stage == 31){
	button[0]="With the smoke cleared. The Alpha alien lays flat";
}
